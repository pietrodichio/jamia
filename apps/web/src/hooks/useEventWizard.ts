...
const eventFormSchema = z.object({
  ...
  desired_bases_min: z.number().min(0, 'Minimo 0').optional(),
  desired_bases_max: z.number().min(0, 'Minimo 0').optional(),
  desired_flyers_min: z.number().min(0, 'Minimo 0').optional(),
  desired_flyers_max: z.number().min(0, 'Minimo 0').optional(),
  auto_promote: z.boolean().optional(),
  public_participants: z.boolean().optional(),
